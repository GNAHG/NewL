...
summon chicken ~ ~-1 ~ {NoAI:true,Silent:true,ActiveEffects:[{Id:14,ShowParticles:false,Duration:2147483646}],Tags:["leadmarker","led"],PersistenceRequired:true,DeathLootTable:"empty",Health:0.1f}
