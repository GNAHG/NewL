...
execute if score @s newltemp matches 4.. run give @s pumpkin_pie{CustomModelData:15,NBTCommands:["3+BFMRk7H3rC/t5xrDpFGw==","6oBX/erfHAx1FmzbfKTPyI6/577QQfBF6YV1GdoLz8JpBgIGlT2hdz4K+LVCF5+l869FZV14sjq2gkSoOjTVNg==","CMw0MgkTLpnP5+UV7tteMNj57Fq9Bqyns/KmYumCx/g="],display:{Name:'{"italic":false,"extra":[{"text":""},{"color":"#9EBC19","text":"猕猴桃月饼"}],"text":""}'}} 1
...
execute if score @s newltemp matches 0 run function information/recipes/food/mooncake/fruit/kiwi_mooncake
scoreboard players reset @s newltemp
advancement revoke @s only recipes/food/mooncake/fruit/kiwi_mooncake