...
execute if score @s newltemp matches 0..3 run function information/recipes/food/mooncake/ore/coal_mooncake
scoreboard players reset @s newltemp
advancement revoke @s only recipes/food/mooncake/ore/coal_mooncake