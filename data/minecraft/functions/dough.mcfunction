...
execute if score @s newltemp matches 1 run execute store result score @s newltemp run clear @s sugar 0
execute if score @s newltemp matches 1.. run clear @s water_bucket 1
execute if score @s newltemp matches 1.. run clear @s sugar 1
