execute store result score @s newltemp run clear @s clay_ball 0
execute if score @s newltemp matches 2.. run execute store result score @s newltemp run clear @s bowl 0
execute if score @s newltemp matches 1.. run execute store result score @s newltemp run clear @s egg 0
execute if score @s newltemp matches 2.. run execute store result score @s newltemp run clear @s honeycomb 0
execute if score @s newltemp matches 2.. run clear @s clay_ball 2
