scoreboard players add @e[tag=entity_dice] newltemp 1
...
kill @e[tag=entity_dice_armor_stand,type=armor_stand,scores={newltemp=130..}]
kill @e[tag=entity_dice,scores={newltemp=130..}]